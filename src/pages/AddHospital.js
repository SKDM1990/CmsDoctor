...
const AddHospital = () => {
  ...
  const { data, isSuccess } = useViewOnlyHospitalQuery({ token: access_token, hospital_ID: id });
            ...
            <div className="row">
                ...
                <div className="auth-cover-wrapper bg-primary-100">
                  <div className="auth-cover">
                    <div className="title text-center">
                      <h1 className="text-primary mb-10"> {listData == "" ? "Add Hospital" : "Edit Hospital"}</h1>
                    </div>
              ...
              <div className="col-lg-8">
                <div className="card-style settings-card-2 mb-30">
                  {listData == "" ? (<form onSubmit={submitHospital} >
                    <div className="row">

                      <div className="col-12 col-lg-6">
                        <div className="input-style-1">
                          <label>Hospital Name</label>
                          <input type="text" className='name1' name='name' placeholder="Full Name" />
                        </div>
                      </div>
                      <div className="col-12 col-lg-6">
                        <div className="input-style-1">
                      ...
                      <form onSubmit={EditHospital} >
                        <div className="row">
                          ...
                          <div className="col-12 mb-5">
                            <input type="file" id="ProfileImamges" className="productImages" onChange={handleChange} name="image" placeholder="" accept=".jpg, .png, jpeg" />
                            <link href="https://use.fontawesome.com/releases/v5.8.2/css/all.css" rel="stylesheet" />
                            <div className='profileImage'>
                              <img src={activeImage == "fetchImage" ? workObj.logo : imageFile} className="main-profile-img fatchImage" />
                          ...
                          <div className="col-12 col-lg-6">
                            <div className="input-style-1">
                              <label>Hospital Name</label>
                              <input type="text" className='name1' defaultValue={workObj.first_name} name='name' placeholder="Full Name" />
                            </div>
                          </div>
                          <div className="col-12 col-lg-6">
                            <div className="input-style-1">
                              <label>Address </label>
                              <input type="text" name="address" defaultValue={workObj.address} placeholder="Enter Address" />
                            </div>
                          </div>
                          <div className="col-12 col-lg-6">
                            <div className="input-style-1">
                              <label>Phone No</label>
                              <input type="number" defaultValue={workObj.mobile} name='phone' placeholder="Phone No" />
                            </div>
                          </div>
                          <div className="col-12 col-lg-6">
                            <div className="input-style-1">
                              <label>City </label>
                              <input type="text" defaultValue={workObj.city} name='city' placeholder="Enter City Name" />
                            </div>
                          </div>
                          {/* <div className="col-12 col-lg-6">
                            <div className="input-style-1">
                          ...
                          <div className="col-12 col-lg-12">
                            <div className="input-style-1">
                              <label>State </label>
                              <input type="text" defaultValue={workObj.state} name='state' placeholder="Enter State" />
                            </div>
                          </div>
                          <div className="col-12">
                            <div className="input-style-1">
